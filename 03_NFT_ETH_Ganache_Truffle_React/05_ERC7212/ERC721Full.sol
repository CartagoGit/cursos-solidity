...
interface IERC721 is IERC165 {
	...
	/**
	 * @dev Transfers a specific NFT (`tokenId`) from one account (`from`)
	 * another (`to`).
	 *
	 *
	 *
...
library SafeMath {
	...
	/**
	 * @dev eturns the integer division of two unsigned integers. Reverts on
...
contract ERC721Enumerable is ERC165, ERC721, IERC721Enumerable {
	...
	function _removeTokenFromAllTokensEnumeration(uint256 tokenId) private {
		...
		// This also deletes the contents at the last position of the array
		//_allTokens.length--;
		delete _allTokens[_allTokens.length.sub(1)];
...
contract ERC721Full is ERC721, ERC721Enumerable, ERC721Metadata {
	...
	function _burn(address owner, uint256 tokenId) internal override(ERC721, ERC721Metadata, ERC721Enumerable) {
