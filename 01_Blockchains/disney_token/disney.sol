...
contract Disney {
    ...
    function SubirseAtraccion(string memory _nombreAtraccion) public {
        ...
        require(
            ...
            "La atracción no esta disponible en estos momentos"
        );

        //Verificar si el cliente tiene tokens suficientes para subirse a la atraccion
        require(
            tokens_atraccion <= MisTokens(),
            "No tienes suficientes tokens para poder acceder a la atracción."
        );
    ...
    function HistorialAtraccionesCliente()
        public
        view
    ...
    function DevolverTokens(uint256 _numTokens) public payable {
        ...
        require(
            ...
            "No puedes devolver mas tokens de los que dispones"
        );
